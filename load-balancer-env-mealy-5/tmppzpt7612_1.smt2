...
(assert (forall ((?_idle_ Bool) (?_m_ M) (?_request0_ Bool) (?_request1_ Bool) (?_request2_ Bool) (?_request3_ Bool) (?_request4_ Bool))  (= (_tau_ ?_idle_ ?_m_ ?_request0_ ?_request1_ ?_request2_ ?_request3_ ?_request4_) _m0_) ))
